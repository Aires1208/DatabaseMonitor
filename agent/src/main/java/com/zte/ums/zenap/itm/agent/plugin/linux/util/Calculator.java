...
public class Calculator {
    ...
    public List<String> calculate(Map<String, List<String>> listMap, String formula)
        ...
        while (true) {
            ...
            formula = AgentUtil.replace(formula, nameString, sumString);
        }
        while (true) {
            ...
            formula = AgentUtil.replace(formula, "COUNT(" + listName + ")", countString);
        }
        ...
        if (listVariables.size() == 0) {
            ...
            for (int j = 0; j < longestSize; j++) {
                ...
                for (String listVariable : listVariables) {
                    ...
                    newFormula = newFormula.replaceAll(String.valueOf(listVariable), thisListItem);
                }
                String resultItem;
                try {
